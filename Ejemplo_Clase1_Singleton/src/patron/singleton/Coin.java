 ...
 **/
public class Coin {
	/*{Crea de antemano cuando levanta el programa (forma eager) una variable la clase (instance) que será la única instancia de la clase.
	 * El constructor es privado para que no se creen más de una instancia (no se puede hacer new).
	 * A la instancia sólo se accede por medio del método getInstance().
