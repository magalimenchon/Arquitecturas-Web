...
public abstract class MazeGame {
	...
	/*{En BD esta sería el manejador de conexiones: makeRoom() sería makeConnection(),
	 * y conectaría a Derby (MagicMazeGame) o MySQL (OrdinaryMazeGame).}*/
	/*{Suele ser singleton.}*/
	...
	//#regionfactorymethod
	/*{Método creador: No puede hacerse un new de Room, ya que esta clase es abstracta.
	 * Si le definiera el tipo a Room, se queda atado al subtipo y pierde flexibilidad el código}*/ 
